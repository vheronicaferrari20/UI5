sap.ui.define([
	...
	"use strict";
	return Object.extend("App.controller.user.UserViewSettingsDialog", {
		_getDialog : function () {
			// create dialog lazily
			if (!this._oDialog) {
				// create dialog via fragment factory
				this._oDialog = sap.ui.xmlfragment("App.view.user.UserViewSettingsDialog", this);
			}
		...
		handleConfirm : function(oEvent) {
			...
			this._eventBus.publish(
				dataEvents.update_viewsettings_user.channel,
				dataEvents.update_viewsettings_user.name,
				{
					aSorters : aSorters,
					aFilters : aFilters,
