sap.ui.define([
	...
	"use strict";
	return sap.ui.jsfragment("App.view.notificaciones.NuevaAsignacion", { 
		createContent: function(oController ) {
			...
			var listItem = new NotificationListItem({
			    			...
			    			description :  '{NotificacionesModel>user} ha creado un nuevo perfil para la oportunidad {NotificacionesModel>datos/opportunityAccountName}',
